...
<template>
  <Section id="recommendations">
    <div class="flex gap-3 items-center">
      ...
      <h2 class="text-3xl">Recomendações</h2>
    </div>
    <p class="mt-2 text-muted">
      Veja os testemunhos de profissionais que recomendam meu trabalho.
    </p>
    ...
    <div class="mt-16 grid grid-cols-[auto_18.3rem] gap-6 items-center">
      <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-1">
          ...
          <div class="font-light">Senior QA Automation Engineer at Blackpoint Cyber</div>
        </div>
      </div>
